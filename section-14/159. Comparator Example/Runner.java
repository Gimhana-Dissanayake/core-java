...
class MyComparator implements Comparator<StringBuffer> {
  ...
  public int compare(StringBuffer sb1, StringBuffer sb2) {
    ...
    // If we want in decending order return negative val(-val);
    return val;
    // shortCut =>return sb1.length() - sb2.length()
  }
}
...
public class Runner {
  ...
  public static void main(String[] args) {
    ...
    TreeSet<StringBuffer> ts = new TreeSet<StringBuffer>(myComparator);
    ts.add(sb1);
    ts.add(sb2);
    ts.add(sb3);
    ts.add(sb4);
