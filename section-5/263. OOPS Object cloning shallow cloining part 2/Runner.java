...
public class Runner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Original Acc Obj Ref : " + originaEmployee.account);// same object
        System.out.println("Duplicate Acc Obj Ref : " + duplicateEmployee.account);// same object
    }
